...
from apps.dashboard.serializers import (
    ...
    InventoryDataDashboardSerializer,
...
class DashboardViewSet(viewsets.ViewSet):
    ...
    @swagger_auto_schema(
        ...
        responses={200: RecentSaleSerializer, 400: "Bad Request", 500: "Internal Server Error"},
    )
    ...
    def get_recent_sales(self, request):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                if result.success:
                    response_serializer = RecentSaleSerializer(data=result.data, many=True)
                    if response_serializer.is_valid():
