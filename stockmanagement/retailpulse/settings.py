...
MAX_MEDIA_UPLOAD_SIZE_BYTES = int(
    os.getenv("MAX_MEDIA_UPLOAD_SIZE_BYTES", "1048576")
)  # Default: 1MB
DATA_UPLOAD_MAX_MEMORY_SIZE = int(os.getenv("DATA_UPLOAD_MAX_MEMORY_SIZE", "1048576"))
FILE_UPLOAD_MAX_MEMORY_SIZE = int(os.getenv("FILE_UPLOAD_MAX_MEMORY_SIZE", "1048576"))
