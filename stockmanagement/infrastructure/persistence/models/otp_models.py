...
class OTP(BaseModel):
    ...
    expires_at = models.DateTimeField(db_index=True, help_text="OTP expires 10 minutes after creation")
    verified = models.BooleanField(default=False)
    verified_at = models.DateTimeField(null=True, blank=True)
    attempts = models.IntegerField(default=0)
    max_attempts = models.IntegerField(default=3, help_text="Maximum 3 verification attempts allowed")
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["email", "purpose", "otp_type", "-created_at"]),
            models.Index(fields=["phone_number", "purpose", "otp_type", "-created_at"]),
