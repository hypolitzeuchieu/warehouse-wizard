...
class StockResponseMixin:
    ...
    def updated_response(
        ...
        """
        return self.success_response(data=data, message=message, status_code=status.HTTP_200_OK)

    def deleted_response(self, message: str = "Resource deleted successfully") -> Response:
        """
    ...
    def validation_error_response(self, serializer_errors: Any) -> Response:
        """
    ...
    def not_found_response(self, resource: str = "Resource") -> Response:
        """
    ...
    def permission_denied_response(
        ...
        """
        return self.error_response(
            code="PERMISSION_DENIED", message=message, status_code=status.HTTP_403_FORBIDDEN
        )

    def authentication_failed_response(self, message: str = "Authentication failed") -> Response:
        """
        Response for authentication failures
        """
        return self.error_response(
            code="AUTHENTICATION_FAILED", message=message, status_code=status.HTTP_401_UNAUTHORIZED
        )

    def internal_error_response(self, error: Exception) -> Response:
        """
